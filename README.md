...
## 🚀 ใช้ได้เลย (Ubuntu / Linux)

โปรเจคนี้ **ใช้ LLM** (Ollama remote) สำหรับวิเคราะห์ config และ topology

เปิด Terminal แล้วรันคำสั่งเดียว (จะถามรหัส sudo ครั้งเดียวถ้ายังไม่มี Docker):
...
รายละเอียด: **[ใช้ได้เลย.md](ใช้ได้เลย.md)**
